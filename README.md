...
[![构建状态](https://img.shields.io/github/actions/workflow/status/your-username/llamacli/ci.yml?branch=main)](https://github.com/your-username/llamacli/actions)
[![许可证](https://img.shields.io/npm/l/llamacli.svg)](https://github.com/your-username/llamacli/blob/main/LICENSE)
...
```bash
# 1. 克隆仓库
git clone https://github.com/your-username/llamacli.git
cd llamacli
...
本项目目前主要由我个人进行开发和维护。如果您对这个项目感兴趣，或有任何想法和建议，非常欢迎通过 [Issues](https://github.com/your-username/llamacli/issues) 与我交流。
