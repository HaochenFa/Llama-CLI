...
export const web_search_tool: ToolDefinition = {
  type: 'native',
  name: 'web_search',
  description: 'Searches the web for information using a search query. Returns a list of search results with titles, URLs, and snippets.',
  parameters: {
    type: 'object',
    properties: {
      query: {
        type: 'string',
        description: "The search query to execute (e.g., 'TypeScript best practices', 'how to fix npm install error').",
      },
      num_results: {
        type: 'number',
